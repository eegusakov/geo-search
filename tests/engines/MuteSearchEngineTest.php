...
class MuteSearchEngineTest extends TestCase
{
    public function testSuccess(): void
    {
        $searchEngine = $this->createMock(SearchEngineInterface::class);
        $searchEngine->method('search')->willReturn($expected = new GeoDto(
            55.75,
            37.62,
            'Moscow',
            'Moscow City',
    ...
    public function testError(): void
    {
        ...
        $errorHandler = $this->createMock(ErrorHandlerInterface::class);
        $errorHandler->method('handle')->willReturnCallback(function () {
